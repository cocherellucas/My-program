  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        style={{ top: '-2px', paddingTop: 'calc(2px + max(44px, env(safe-area-inset-top)))' }}
        className="fixed left-0 right-0 z-50 shadow-xl" style={{ ...{}, background: 'linear-gradient(to right, #1e0050, #2e1065)' }}>
