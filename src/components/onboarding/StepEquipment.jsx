  ...
  return (
    <div className="space-y-6">
      ...
      {sansMateriel && !showContextPicker && (
        // Trois blocs de même poids s'empilaient — un récapitulatif, une
        // explication et un BOUTON, tous en bg-white/10 : rien ne se distinguait
        // et le bouton ne se lisait pas comme cliquable. L'explication redescend
        // au rang de texte secondaire (elle ne fait que confirmer la ligne du
        // dessus), et le bouton reprend le style bordé des autres actions de
        // l'écran, comme « Vérifier mon matériel ».
        <div className="space-y-4">
          <p className="text-sm text-white/60 leading-relaxed px-1">{t('eq_none_ok')}</p>
