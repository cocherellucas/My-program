          ...
          {NAV_PATHS.map((path, idx) => {
            ...
            return (
              <div
                ...
                // bg-violet-800 évite l'écart visible si le contenu ne remplit pas tout l'écran
                className={`bg-violet-800 ${keyboardOpen ? 'pb-2' : 'pb-[calc(6rem+env(safe-area-inset-bottom))] md:pb-0'}`}
              >
