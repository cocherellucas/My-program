...
export const KNOWLEDGE_BASE = [
  ...
  },
  {
    id: 'order_003',
    topic: 'exercise_order',
    subtopics: ['mind-muscle connection', 'ressenti', 'recrutement', 'pré-fatigue'],
    finding: 'Quand un utilisateur ne "sent pas" le muscle cible sur un exercice composé, cela indique un déficit de recrutement — d\'autres muscles compensent.',
    detail: 'Solutions par ordre de priorité : 1) Correction technique (tempo, ROM, position) 2) Réduire la charge pour se concentrer sur le ressenti 3) Changer d\'exercice pour un pattern plus simple 4) Pré-fatigue de l\'isolation (dernier recours, avancés/intermédiaires en hypertrophie seulement). La pré-fatigue n\'est PAS une solution de premier recours — elle masque un problème technique sans le résoudre.',
    source: 'Calatayud et al. (2016) — J Human Kinetics ; Snyder & Leech (2009)',
    application: 'Si un utilisateur dit "je ne sens pas mes pecs au développé", proposer dans l\'ordre : ajuster l\'écartement/prise, ralentir le tempo excentrique, réduire la charge. Pré-fatigue seulement si les autres solutions échouent ET niveau intermédiaire+ EN hypertrophie.',
    example: '"Je ne sens pas mes quadriceps au squat" → d\'abord : squat goblet avec pause en bas, tempo 3-1-1. Si toujours inefficace après plusieurs séances → leg extension 3×15 juste avant squat.',
    objectives: ['hypertrophy'],
    levels: ['intermediate', 'advanced'],
    muscles: ['Quadriceps', 'Pectoraux', 'Dos', 'Épaules'],
    keywords: ['ressenti', 'mind muscle', 'recrutement', 'connexion musculaire', 'pré-fatigue', 'compensation'],
  },
  {
    id: 'rep_range_beginner_001',
    topic: 'rep_range',
    subtopics: ['débutant', 'hypertrophie', 'sécurité', 'plage reps'],
    finding: 'Pour un débutant en hypertrophie, descendre en dessous de 8 répétitions n\'apporte aucun bénéfice supplémentaire et augmente significativement le risque de blessure.',
    detail: 'Les débutants progressent avec des charges modérées (60-70% 1RM) grâce aux adaptations neuronales massives de la phase initiale. Charger lourd (1-7 reps) sur technique non établie = risque disproportionné sans gain. La plage 8-15 reps offre le meilleur rapport bénéfice/risque : suffisamment de reps pour répéter et consolider le mouvement, charge assez faible pour rester safe, stimulus suffisant pour la progression neuronale et hypertrophique simultanée.',
    source: 'Schoenfeld et al. (2017) — J Strength Cond Res ; Kraemer & Ratamess (2004) — Med Sci Sports Exerc',
    application: 'RÈGLE ABSOLUE hypertrophie débutant : minimum 8 reps sur tous les exercices. Idéalement 8-15 reps. Jamais de charges maximales ou sub-maximales (1-7 reps) tant que la technique n\'est pas solidement établie (minimum 3-6 mois de pratique régulière).',
    example: 'Débutant qui veut faire du 5×5 en hypertrophie → refuser et proposer 4×10 à la place. Exception : si l\'objectif déclaré est force (pas hypertrophie), le 5×5 peut être adapté avec progression technique.',
    objectives: ['hypertrophy'],
    levels: ['beginner'],
    muscles: [],
    keywords: ['débutant', 'plage reps', 'minimum 8 reps', 'sécurité', 'technique', 'hypertrophie'],
  },
  {
